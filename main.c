...
int main(){
  ...
  test_fix_N("fix_n_res1", multiply, 10, "res_fixed_n1.txt");
  test_fix_N("fix_n_res2", multiply, 10, "res_fixed_n2.txt");
  test_fix_N("fix_n_res3", multiply, 10, "res_fixed_n3.txt");
